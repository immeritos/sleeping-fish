...
export function PhotoSeriesClient({ series }: PhotoSeriesClientProps) {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="md:w-2/5 lg:w-2/5 md:fixed md:h-screen pt-24 md:pt-40 pb-12 px-6 md:px-12 flex flex-col md:justify-center font-inter">
      ...
      <div className="md:ml-[45%] lg:ml-[45%] md:w-[55%] lg:w-[55%]">
        <div className="pt-6 md:pt-[50vh] md:-mt-[200px] pb-16 px-3 md:px-6 space-y-3 md:space-y-5">
